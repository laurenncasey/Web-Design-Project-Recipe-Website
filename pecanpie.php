...
<link rel='icon' type='image/x-icon' href='images/export2White.png'>            
            <title>Casey's Pecan Pie Recipe</title> </head>
...
<body>
    ...
    <div class = 'totalPage'>
        ...
        <div class='content2'>
            <img class = 'food2' src='../WebsiteProject/images/oldpecan.jpg' alt='Pecan Pie'>
            <img class = 'food2' src='../WebsiteProject/images/pecan2020.jpeg' alt='Pecan Pie'>
            <img class = 'food2' src='../WebsiteProject/images/pec.jpeg' alt='Pecan Pie'>

        </div>

        <h1 class = 'recipeNameh1'>Pecan Pie</h1>
