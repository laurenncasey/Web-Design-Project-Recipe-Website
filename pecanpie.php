...
<body class = 'bodyTest'>
    ...
    <h1 class='title'>Pecan Pie</h1>
    </div>

    <div class ='imgs'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 3);' src = '../WebsiteProject/images/oldpecan.jpg' alt = 'Pecan Pie'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 3);' src = '../WebsiteProject/images/pec.jpeg' alt = 'pecan pie'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 3);' src = '../WebsiteProject/images/pecan2020.jpeg' alt = 'pecan pie'>
    </div>
    <div class = 'book'>
    ...
    <p class='ingr'>";
                        ...
                        $sql = "SELECT ingredients FROM recipes WHERE title = 'Pecan Pie'";
            ...
            $sql = "SELECT directions FROM recipes WHERE title = 'Pecan Pie'";
