...
<link rel='icon' type='image/x-icon' href='images/export2White.png'>            <title>Casey's Chocolate Chip Cookies Recipe</title> </head>
...
<body>
    ...
    <div class = 'totalPage'>
        ...
        <div class='content2'>
            <img class = 'food2' src='../WebsiteProject/images/chocChipCookie.JPG' alt='Cookies'>
          

        </div>

        <h1 class = 'recipeNameh1'>Chocolate Chip Cookies</h1>
        ...
        <div class='book'>
            ...
            <p class='para'>";
                        ...
                        $sql = "SELECT ingredients FROM recipes WHERE title = 'Chocolate Chip Cookies'";
            ...
            $sql = "SELECT directions FROM recipes WHERE title = 'Chocolate Chip Cookies'";
