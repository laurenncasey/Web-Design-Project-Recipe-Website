...
<link rel='icon' type='image/x-icon' href='images/export2White.png'>            
            <title>Casey's Pumpkin Pie Recipe</title> </head>
...
<body>
    ...
    <div class = 'totalPage'>
        ...
        <div class='content2'>
            <img class = 'food2' src='../WebsiteProject/images/IMG_0029.HEIC' alt='Pumpkin Pie'>

        </div>

        <h1 class = 'recipeNameh1'>Pumpkin Pie</h1>
        ...
        <div class='book'>
            ...
            <p class='para'>";
                        ...
                        $sql = "SELECT ingredients FROM recipes WHERE title = 'Pumpkin Pie'";
            ...
            $sql = "SELECT directions FROM recipes WHERE title = 'Pumpkin Pie'";
