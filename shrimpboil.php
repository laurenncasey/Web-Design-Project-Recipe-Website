...
<body class = 'bodyTest'>
    ...
    <h1 class='title'>Old Bay Cajun Shrump Boil</h1>
    </div>

    <div class ='imgs'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 4);' src = '../WebsiteProject/images/shrimp.jpg' alt = 'shrimp boil'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 4);' src = '../WebsiteProject/images/shrimpboil.jpg' alt = 'shrimp boil'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 4);' src = '../WebsiteProject/images/shrimpclose.jpeg' alt = 'shrimp boil'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 4);' src = '../WebsiteProject/images/shrimpLayout.jpg' alt = 'shrimp boil'>
    </div>
    <div class = 'book'>
    ...
    <p class='ingr'>";
                        ...
                        $sql = "SELECT ingredients FROM recipes WHERE title = 'Shrimp Boil'";
            ...
            $sql = "SELECT directions FROM recipes WHERE title = 'Shrimp Boil'";
