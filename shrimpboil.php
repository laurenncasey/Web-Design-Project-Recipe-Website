...
<link rel='icon' type='image/x-icon' href='images/export2White.png'>            
            <title>Casey's Shrimp Boil Recipe</title> </head>
...
<body>
    ...
    <div class = 'totalPage'>
        ...
        <div class='content2'>
            <img class = 'food2' src='../WebsiteProject/images/shrimp.JPG' alt='Shrimp'>
            <img class = 'food2' src='../WebsiteProject/images/shrimpboil.JPG' alt='Shrimp Boil'>
            <img class = 'food2' src='../WebsiteProject/images/shrimp.JPG' alt='Shrimp'>

        </div>

        <h1 class = 'recipeNameh1'>Cajun Shrimp Boil</h1>
