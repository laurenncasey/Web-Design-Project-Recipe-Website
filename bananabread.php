...
<link rel='icon' type='image/x-icon' href='images/export2White.png'>            <title>Casey's Banana Bread Recipe</title> </head>
...
<body>
    ...
    <div class = 'totalPage'>
        ...
        <div class='content2'>
                        <img class = 'food2' src='../WebsiteProject/images/bananaBread.jpg' alt='Banana Bread'>
                        <img class = 'food2' src='../WebsiteProject/images/banbread.jpg' alt='Banana Bread'>
                        <img class = 'food2' src='../WebsiteProject/images/bananaBread.jpg' alt='Banana Bread'>

        </div>

        <h1 class = 'recipeNameh1'>Banana Nut Bread</h1>
        ...
        <div class='book'>
            ...
            <p class='para'>";
                        ...
                        $sql = "SELECT ingredients FROM recipes WHERE title = 'Banana Nut Bread'";
            ...
            $sql = "SELECT directions FROM recipes WHERE title = 'Banana Nut Bread'";
