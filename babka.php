...
<html> <head> <link rel='stylesheet' href='css/style.css'>
 ...
 <meta charset='UTF-8'> <meta http-equiv='X-UA-Compatible' content='IE=edge'>
  ...
  <link rel='icon' type='image/x-icon' href='images/export2White.png'>            
            <title>Casey's Babka Loaf Recipe</title> </head>
...
<body>
    ...
    <div class = 'totalPage'>
        ...
        <div class='content2'>
        <img class = 'food2' src='../WebsiteProject/images/rawBread.jpeg' alt='Raw Babka Loaves'>
        <img class = 'food2' src='../WebsiteProject/images/babbread.jpg' alt='Babka Bread'>
        <img class = 'food2' src='../WebsiteProject/images/babkaSlice.jpg' alt='Babka Slice'>
        
        </div>

        <h1 class = 'recipeNameh1'>Sticky Caramel-Pecan Babka Loaf</h1>
