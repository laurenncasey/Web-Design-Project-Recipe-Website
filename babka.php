...
<body class = 'bodyTest'>
    ...
    <h1 class='title'>Sticky Caramel-Pecan Babka Bread</h1>
    </div>

    <div class ='imgs'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 4);' src = '../WebsiteProject/images/babbread.jpg' alt = 'babka loaf'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 4);' src = '../WebsiteProject/images/babkaBread.jpeg' alt = 'babka loaf'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 4);' src = '../WebsiteProject/images/babkaSlice.jpg' alt = 'babka loaf'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 4);' src = '../WebsiteProject/images/rawBread.jpeg' alt = 'babka loaf'>
    </div>
    <div class = 'book'>
    ...
    <p class='ingr'>";
                        ...
                        $sql = "SELECT ingredients FROM recipes WHERE title = 'Sticky Caramel-Pecan Babka Loaf'";
            ...
            $sql = "SELECT directions FROM recipes WHERE title = 'Sticky Caramel-Pecan Babka Loaf'";
