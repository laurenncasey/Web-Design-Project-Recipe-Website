...
<link rel='icon' type='image/x-icon' href='images/export2White.png'>            
            <title>Casey's Peanut Butter Cookies Recipe</title> </head>
...
<body>
    ...
    <div class = 'totalPage'>
        ...
        <div class='content2'>
            <img class = 'food2' src='../WebsiteProject/images/pbCookie.JPG' alt='Peanut Butter Cookies'>

        </div>

        <h1 class = 'recipeNameh1'>Peanut Butter Cookies</h1>
        ...
        <div class='book'>
            ...
            <p class='para'>";
                        ...
                        $sql = "SELECT ingredients FROM recipes WHERE title = 'Peanut Butter Cookies'";
            ...
            $sql = "SELECT directions FROM recipes WHERE title = 'Peanut Butter Cookies'";
