...
<html> <head> <link rel='stylesheet' href='css/style.css'>
 ...
 <link rel='icon' type='image/x-icon' href='images/export2White.png'>            
            <title>Casey's Lemon Meringue Recipe</title> </head>
...
<body>
    ...
    <div class = 'totalPage'>
        ...
        <div class='content2'>
            <img class = 'food2' src='../WebsiteProject/images/lm.jpeg' alt='Lemon Meringue Pie'>
            <img class = 'food2' src='../WebsiteProject/images/LemonMer.jpg' alt='Lemon Meringue Pie'>

        </div>

        <h1 class = 'recipeNameh1'>Lemon Meringue Pie</h1>
        ...
        <div class='book'>
            ...
            <p class='para'>";
                        ...
                        $sql = "SELECT ingredients FROM recipes WHERE title = 'Lemon Meringue Pie'";
            ...
            $sql = "SELECT directions FROM recipes WHERE title = 'Lemon Meringue Pie'";
