...
<link rel='icon' type='image/x-icon' href='images/export2White.png'>            
            <title>Casey's Lemon Pound Recipe</title> </head>
...
<body>
    ...
    <div class = 'totalPage'>
        ...
        <div class='content2'>
                                    <img class = 'food2' src='../WebsiteProject/images/lemonpound.JPG' alt='Lemon Pound Cake'>

        </div>

        <h1 class = 'recipeNameh1'>Lemon Pound Cake</h1>
        ...
        <div class='book'>
            ...
            <p class='para'>";
                        ...
                        $sql = "SELECT ingredients FROM recipes WHERE title = 'Lemon Pound Cake'";
            ...
            $sql = "SELECT directions FROM recipes WHERE title = 'Lemon Pound Cake'";
