...
<body class = 'bodyTest'>
    ...
    <div class ='imgs'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 3);' src = '../WebsiteProject/images/BakedCinRolls.jpg' alt = 'Cinnamon Rolls'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 3);' src = '../WebsiteProject/images/BakedNutCinRolls.jpg' alt = 'Cinnamon Rolls'>
        <img class= 'imagerec' style = 'width: calc((100vw - 25px )/ 3);' src = '../WebsiteProject/images/RawCinRolls.jpg' alt = 'Unbaked Cinnamon Rolls'>
    </div>
    <div class = 'book'>
    ...
    <p class='ingr'>";
                        ...
                        $sql = "SELECT ingredients FROM recipes WHERE title = 'Cinnamon Rolls'";
            ...
            $sql = "SELECT directions FROM recipes WHERE title = 'Cinnamon Rolls'";
