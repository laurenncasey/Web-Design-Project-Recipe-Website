...
<link rel='icon' type='image/x-icon' href='images/export2White.png'>            <title>Casey's Cinnamon Rolls Recipe</title> </head>
...
<body>
    ...
    <div class = 'totalPage'>
        ...
        <div class='content2'>
            <img class = 'food2' src='../WebsiteProject/images/BakedCinRolls.jpg' alt='Cinnamon Rolls'>

        </div>

        <h1 class = 'recipeNameh1'>Cinnamon Rolls</h1>
